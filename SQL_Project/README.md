...
Data hails originally from the kaggle dataset:[Data Analyst Job Postings](https://www.kaggle.com/datasets/lukebarousse/data-analyst-job-postings-google-search/data). It's packed with data on data analyst job titles, salaries, locations, companies, job postings, and skills compiled daily from google search engine results for Data Analyst Job Postings. Luke Barousse compiled the dataset and set it as the foundation for his course [SQL For Data Analytics](https://www.youtube.com/watch?v=7mz73uXD9DA&t=11150s) 
...
**To view the Tableau dashbaords created sumarizing this project head over to my [Tableau Profile](https://public.tableau.com/app/profile/patrick.lutz/vizzes)**
