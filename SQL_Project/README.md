...
Data hails originally from the [kaggle dataset:Google Search Engine Results for Data Analyst Job Postings](https://www.kaggle.com/datasets/lukebarousse/data-analyst-job-postings-google-search/data). It's packed with data on data analyst job titles, salaries, locations, companies, job postings, and skills. Luke Barousse compiled the dataset and set it as the foundation for his course [SQL For Data Analytics](https://www.youtube.com/watch?v=7mz73uXD9DA&t=11150s) 
